...
<body>
	<div class="main"> 
		<div class="form-box">
			...
			<form id="Login" class="input-group" action="sql_islem.php" method="post"><!--method="post" eğer bu kısmı böyle vermezsem veritabanı bağlantısında post özelliğine kod yazamam.-->
